...
body {
	...
	background: url(../../../../Public/image/green.jpg) fixed;
...
img{ border:0}
	...
	.nav_1 ul{list-style:none; margin-left:-40px; margin-top:-5px;}
	...
	.content{ width:760px; float:left; margin:10px 0 10px 20px; background-color:#F7F7F7; padding:10px; text-indent:10px;}
	
	.footer{ width:960px; height:70px; background:url(../../../../Public/image/foot.jpg) no-repeat center; margin-top:10px; clear:left; border:#CF6 dotted 1px }
