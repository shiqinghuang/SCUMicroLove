		 ...
		 <div class="apply_con">
			...
			<form id="form1" name="form1" method="post" action="">
				<table>
					...
					<tr>
						<td>查询密码:</td>
						<td><input type="password" name="querytoken" id="querytoken"/></td>
						<td colspan="2" style="color:red">（请设置6位数查询密码）</td>
					</tr>
					<tr>
						<td>确认密码:</td>
						<td><input type="password" name="requerytoken" id="requerytoken" /></td>
					</tr>
