...
<div class="container">
    ...
    <div id="content">
        ...
        <div class="main">
            <!--选择按钮内容S-->
            <ul class="sel_btn">
                <a href="Index"> <li>未认领</li></a>
                <a href="Indexn"><li class="hovered">已认领</li></a>
            </ul>
            ...
            <div class="con">
                ...
                <div class="sel_con">
                    <ul>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><strong>【如愿以偿】&nbsp;&nbsp;</strong>【<?php echo ($vo["postdate"]); ?>】</span><?php echo ($vo["wishstory_id"]); ?><a href="Preview?id=<?php echo ($vo["wishstory_id"]); ?>"><?php echo ($vo["wishstory_name"]); ?></a>
